...
import { BriefcaseBusiness, MonitorCloud, Waypoints } from "lucide-react";
...
const Logo = () => {
  return (
    ...
    >
      {/* --- Logo Mark (Icon) --- */}
      <div className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-primary text-primary-foreground shadow-lg transition-all duration-300 group-hover:scale-80 group-hover:rotate-45 group-hover:shadow-primary/40">
        <Waypoints  size={24} strokeWidth={2} />
