      ...
      <div className="">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-16">
            ...
            <div className="md:w-1/2 text-center md:text-left order-2 md:order-1   p-8 rounded-2xl shadow-lg">
              <h1 className="text-2xl sm:text-3xl lg:text-3xl font-extrabold leading-tight  tracking-tight   ">
