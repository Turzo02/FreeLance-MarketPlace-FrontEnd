  ...
  return (
    <div className="min-h-screen  shadow-sm rounded-sm p-8 md:p-12">
      <div className="max-w-4xl mx-auto  space-y-8">
        <h1 className="text-4xl font-bold text-center mb-4   ">About FreeLance MarketPlace</h1>
        ...
        <section className="text-center">
          <p className="text-lg font-medium">
            Join <span className="   font-semibold">FreeLance MarketPlace</span>  today and experience a smarter way to connect, collaborate, and succeed!
          </p>
        </section>
      </div>
    </div>
