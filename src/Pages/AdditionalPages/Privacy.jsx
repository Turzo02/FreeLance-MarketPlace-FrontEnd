    ...
    <div className="min-h-screen p-8 md:p-12">
      <div className="max-w-4xl mx-auto space-y-8 ">
        ...
        <section className="space-y-2">
          <p className="text-lg">
            At <span className="font-semibold text-indigo-500">FreeLance MarketPlace</span>, your privacy and data security are our top priorities. 
        ...
        {/* Privacy Policy */}
        <section className="space-y-2">
          <h2 className="text-2xl font-semibold text-indigo-500">Privacy Policy</h2>
          <p className="text-lg">
        ...
        {/* Terms of Service */}
        <section className="space-y-2">
          <h2 className="text-2xl font-semibold text-indigo-500">Terms of Service</h2>
          <p className="text-lg">
        ...
        <section className="space-y-2">
          <h2 className="text-2xl font-semibold text-indigo-500">User Responsibilities</h2>
        ...
        <section className="text-center mt-4">
          <p className="text-lg">
            By using <span className="font-semibold text-indigo-500">FreeLance MarketPlace</span>, you acknowledge and agree to these policies.
          </p>
        </section>
      </div>
    </div>
