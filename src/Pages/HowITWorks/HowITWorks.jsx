      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, index) => (
            <div
              key={index}
              className="bg-[rgba(255,255,255,0.05)] border border-indigo-500 rounded-sm p-6 text-center hover:shadow-md transition"
            >
              <div className="w-12 h-12 mx-auto flex items-center justify-center bg-indigo-500 text-white rounded-sm mb-4">
                {step.icon}
              </div>
